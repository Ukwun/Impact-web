...
import { CheckCircle, ArrowRight, Calendar, Users, Award, Zap } from "lucide-react";
      ...
      <section className="relative pt-32 pb-16 bg-gradient-to-b from-dark-900 via-blue-900/20 to-dark-900 overflow-hidden">
        <div className="relative z-10 container mx-auto px-6">
          <div className="max-w-3xl mx-auto text-center space-y-6">
            <h1 className="text-5xl font-black text-white">Join Impact Club</h1>
            <p className="text-xl text-gray-300">
              {programme !== "general"
                ? `Get started with ${selectedProgramme.name}`

        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link href="/impacthub" className="hover:text-primary-400 transition-colors">ImpactHub</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link href="/learning" className="hover:text-primary-400 transition-colors">Certifications</Link></li>
              <li><Link href="/learning" className="hover:text-primary-400 transition-colors">Learning Experience</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link href="/community" className="hover:text-primary-400 transition-colors">Become a Facilitator</Link></li>
              <li><Link href="/events" className="hover:text-primary-400 transition-colors">Startup Support</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link href="/learning" className="hover:text-primary-400 transition-colors">Financial Literacy Hub</Link></li>
              <li><Link href="/blog" className="hover:text-primary-400 transition-colors">Entrepreneurship Resources</Link></li>
              <li><Link href="/learning" className="hover:text-primary-400 transition-colors">Investment Education</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link href="/legal/terms" className="hover:text-primary-400 transition-colors">Terms</Link></li>
              <li><Link href="/legal/code-of-conduct" className="hover:text-primary-400 transition-colors">Code of Conduct</Link></li>
              <li><Link href="/legal/compliance" className="hover:text-primary-400 transition-colors">Compliance</Link></li>
            </ul>
          </div>
        </div>

...
export async function seedLearningArchitectureCmsData() {
  const frameworkSeeds: Array<{
    ...
    },
    {
      ...
      purpose: "Build venture design discipline, financial projection confidence, and presentation readiness before learners transition into advanced execution environments.",
      coreOutcomes: [
      ...
      liveClassroomFormat:
        "One live class per week, 75 minutes, supported by a monthly venture lab and a quarterly showcase or pitch day with structured feedback rubrics.",
      terms: [
        {
          term: "Term 1",
    ...
    },
    {
      ...
      purpose: "Move older learners from understanding to execution through venture building, professional capital development, funding literacy, and applied institutional engagement.",
      coreOutcomes: [
      ...
      liveClassroomFormat:
        "One 90-minute masterclass weekly, one studio or clinic every two weeks, monthly mentor office hours, and quarterly showcase or challenge events.",
      terms: [
        {
          term: "Term 1",
